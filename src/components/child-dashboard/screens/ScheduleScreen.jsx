...
export default function ScheduleScreen() {
  const schedule = [
    { status: "NOW", badgeBg: "bg-[#3ECFB2]", textStyle: "text-white", boxStyle: "bg-white border-l-4 border-[#3ECFB2] shadow-md scale-[1.02]", emoji: "🎮", name: "Feelings Game" },
    { status: "AFTER", badgeBg: "bg-[#8FA3B1]/20", textStyle: "text-[#8FA3B1]", boxStyle: "bg-white/40 border border-white/60 opacity-80", emoji: "🔤", name: "Word Match" },
    { status: "THEN", badgeBg: "bg-[#8FA3B1]/20", textStyle: "text-[#8FA3B1]", boxStyle: "bg-white/40 border border-white/60 opacity-80", emoji: "🧩", name: "Puzzle Time" },
    { status: "🌟", badgeBg: "bg-[#C4B5FD]", textStyle: "text-white", boxStyle: "bg-[#C4B5FD]/20 border border-[#C4B5FD] opacity-80", emoji: "🎉", name: "All finished!" },
  ];
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 h-[200px] md:h-[400px]">
            <div className="rounded-3xl p-6 flex flex-col items-center gap-4 bg-[#3ECFB2]/20 border-2 border-[#3ECFB2] shadow-sm justify-center group hover:bg-[#3ECFB2]/30 transition-colors">
              ...
              <span className="text-5xl md:text-[80px] my-2 group-hover:scale-110 transition-transform">{schedule[0].emoji}</span>
            ...
            <div className="rounded-3xl p-6 flex flex-col items-center gap-4 bg-[#FFF4E3] border-2 border-[#FFA94D] shadow-sm justify-center group hover:bg-[#FFE8C2] transition-colors">
              ...
              <span className="text-5xl md:text-[80px] my-2 group-hover:scale-110 transition-transform">{schedule[1].emoji}</span>
